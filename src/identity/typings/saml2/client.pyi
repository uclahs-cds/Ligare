...
class Saml2Client(Base):
    ...
    def prepare_for_authenticate(self, entityid=..., relay_state=..., binding=..., vorg=..., nameid_format=..., scoping=..., consent=..., extensions=..., sign=..., sigalg=..., digest_alg=..., response_binding=..., **kwargs): # -> tuple[Any, dict[str, Any] | dict[str, str]]:
