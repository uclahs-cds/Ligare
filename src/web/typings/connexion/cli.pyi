...
AVAILABLE_APPS = ...
DEFAULT_SERVERS = ...
def validate_server_requirements(ctx, param, value): # -> None:
    ...
...
def run(spec_file, base_module_path, port, host, wsgi_server, server, stub, mock, hide_spec, hide_console_ui, console_ui_url, console_ui_from, auth_all_paths, validate_responses, strict_validation, debug, verbose, base_path, app_framework): # -> None:
    """
