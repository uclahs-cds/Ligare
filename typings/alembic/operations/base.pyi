...
class AbstractOperations(util.ModuleClsProxy):
    ...
    _to_impl = ...
    def __init__(self, migration_context: MigrationContext, impl: Optional[BatchOperationsImpl] = ...) -> None:
    ...
    def inline_literal(self, value: Union[str, int], type_: Optional[TypeEngine[Any]] = ...) -> _literal_bindparam:
...
class Operations(AbstractOperations):
    ...
    """
    if TYPE_CHECKING:
        def add_column(self, table_name: str, column: Column[Any], *, schema: Optional[str] = ...) -> None:
        ...
        def create_exclude_constraint(self, constraint_name: str, table_name: str, *elements: Any, **kw: Any) -> Optional[Table]:
        ...
        def create_unique_constraint(self, constraint_name: Optional[str], table_name: str, columns: Sequence[str], *, schema: Optional[str] = ..., **kw: Any) -> Any:
        ...
        def drop_column(self, table_name: str, column_name: str, *, schema: Optional[str] = ..., **kw: Any) -> None:
        ...
        def drop_constraint(self, constraint_name: str, table_name: str, type_: Optional[str] = ..., *, schema: Optional[str] = ...) -> None:
        ...
        def rename_table(self, old_table_name: str, new_table_name: str, *, schema: Optional[str] = ...) -> None:
...
class BatchOperations(AbstractOperations):
    ...
    if TYPE_CHECKING:
        def add_column(self, column: Column[Any], *, insert_before: Optional[str] = ..., insert_after: Optional[str] = ...) -> None:
            """Issue an "add column" instruction using the current
        ...
        def create_foreign_key(self, constraint_name: str, referent_table: str, local_cols: List[str], remote_cols: List[str], *, referent_schema: Optional[str] = ..., onupdate: Optional[str] = ..., ondelete: Optional[str] = ..., deferrable: Optional[bool] = ..., initially: Optional[str] = ..., match: Optional[str] = ..., **dialect_kw: Any) -> None:
            """Issue a "create foreign key" instruction using the
            current batch migration context.
        ...
        def drop_constraint(self, constraint_name: str, type_: Optional[str] = ...) -> None:
