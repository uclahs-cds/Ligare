...
def create_unique_constraint(constraint_name: Optional[str], table_name: str, columns: Sequence[str], *, schema: Optional[str] = ..., **kw: Any) -> Any:
...
def drop_column(table_name: str, column_name: str, *, schema: Optional[str] = ..., **kw: Any) -> None:
...
def drop_constraint(constraint_name: str, table_name: str, type_: Optional[str] = ..., *, schema: Optional[str] = ...) -> None:
...
def rename_table(old_table_name: str, new_table_name: str, *, schema: Optional[str] = ...) -> None:
