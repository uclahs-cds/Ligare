...
from typing import Any, Callable, Collection, ContextManager, Dict, List, Mapping, MutableMapping, Optional, TYPE_CHECKING, TextIO, Tuple, Union, overload
...
ProcessRevisionDirectiveFn = Callable[[MigrationContext, Tuple[str, str], List["MigrateOperation"]], None]
...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    def configure(self, connection: Optional[Connection] = ..., url: Optional[Union[str, URL]] = ..., dialect_name: Optional[str] = ..., dialect_opts: Optional[Dict[str, Any]] = ..., transactional_ddl: Optional[bool] = ..., transaction_per_migration: bool = ..., output_buffer: Optional[TextIO] = ..., starting_rev: Optional[str] = ..., tag: Optional[str] = ..., template_args: Optional[Dict[str, Any]] = ..., render_as_batch: bool = ..., target_metadata: Optional[MetaData] = ..., include_name: Optional[IncludeNameFn] = ..., include_object: Optional[IncludeObjectFn] = ..., include_schemas: bool = ..., process_revision_directives: Optional[ProcessRevisionDirectiveFn] = ..., compare_type: bool = ..., compare_server_default: Union[bool, CompareServerDefault] = ..., render_item: Optional[RenderItemFn] = ..., literal_binds: bool = ..., upgrade_token: str = ..., downgrade_token: str = ..., alembic_module_prefix: str = ..., sqlalchemy_module_prefix: str = ..., user_module_prefix: Optional[str] = ..., on_version_apply: Optional[OnVersionApplyFn] = ..., **kw: Any) -> None:
