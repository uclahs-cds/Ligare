...
def assert_raises(except_cls, callable_, *args, **kw): # -> Any:
    ...

def assert_raises_context_ok(except_cls, callable_, *args, **kw): # -> Any:
    ...

def assert_raises_message(except_cls, msg, callable_, *args, **kwargs): # -> Any:
    ...

def assert_raises_message_context_ok(except_cls, msg, callable_, *args, **kwargs): # -> Any:
    ...
