...
from typing import Any, Callable, Collection, ContextManager, Dict, List, Literal, Mapping, MutableMapping, Optional, TYPE_CHECKING, TextIO, Tuple, Union, overload
...
def execute(sql: Union[ClauseElement, str], execution_options: Optional[dict] = ...) -> None:
